...
#define SPINNAKER_DEPRECATED_API                                                                                       \
    __declspec(deprecated(                                                                                             \
        "Spinnaker support for Visual Studio 2013 is deprecated, please upgrade to Visual Studio 2015 instead"))
#elif _MSC_VER == 1600
#define SPINNAKER_DEPRECATED_API                                                                                       \
    __declspec(deprecated(                                                                                             \
        "Spinnaker support for Visual Studio 2010 is deprecated, please upgrade to Visual Studio 2015 instead"))
#endif
