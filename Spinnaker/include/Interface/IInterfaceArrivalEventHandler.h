...
#ifndef FLIR_SPINNAKER_IINTERFACE_ARRIVAL_EVENT_HANDLER_H
#define FLIR_SPINNAKER_IINTERFACE_ARRIVAL_EVENT_HANDLER_H
...
#endif // FLIR_SPINNAKER_IINTERFACE_ARRIVAL_EVENT_HANDLER_H