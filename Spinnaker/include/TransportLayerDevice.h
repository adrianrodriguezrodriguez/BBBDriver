...
namespace Spinnaker
{
	...
	*/
	...
	public:
		...
		/**
		 * Description: Selector for the different stream channels. This value can be used when fetching the TL Stream Nodemap and does not control which streams are active.
		 * Visibility: Beginner
		 */
