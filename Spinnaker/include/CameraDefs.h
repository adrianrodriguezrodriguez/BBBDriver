...
namespace Spinnaker
{
    ...
    */
    ...
    enum ActionSelectorEnums    /*!< Selects to which Action Signal further Action settings apply.*/
    {
    ...
    enum GainConversionEnums    /*!< Selects which gain conversion mode to use.*/
    {
        GainConversion_LCG,    /*!< */
        GainConversion_HCG,    /*!< */
        NUM_GAINCONVERSION
    ...
    enum DefectCorrectionModeEnums    /*!< Controls the method used for replacing defective pixels.*/
    {
    ...
    enum DeviceSensorChromaEnums    /*!< Indicates whether the camera is polarized mono, mono or color.*/
    {
    ...
    enum ExternalVoltageSelectorEnums    /*!< Selects the kind of generated output voltage: 3.3V, 5.0V, Adjustable (0-10V)*/
    {
    ...
    enum FfcModeEnums    /*!< Selects flat field correction mode. Note that flat field correction parameters are accessible only in Calibration mode. When switching modes from Calibration to User or Factory, it is recommended to stop image streaming to give the camera enough time to load the corresponding table.*/
    {
        FfcMode_Factory,    /*!< */
        FfcMode_User,    /*!< */
        FfcMode_Calibration,    /*!< */
    ...
    enum MultiRoiSelectorEnums    /*!< Selects the Region of interest to control. The RegionSelector feature allows devices that are able to extract multiple regions out of an image.*/
    {
    ...
    enum CompressionSaturationPriorityEnums    /*!< When FrameRate is enabled, camera drops frames if datarate is saturated. If FrameRate is disabled, camera adjusts the framerate to match the maximum achievable datarate.*/
    {
    ...
    enum ComponentSelectorEnums    /*!< Control for selecting the component of a source (i.e. Raw/Rectified/Disparity).*/
    {
    ...
    enum ImageCompressionModeEnums    /*!< Enabling lowers bandwidth usage or increases frame rate for typical scenes. For Lossless, ISP must be off and Pixel format must be Mono8 or BayerRG8.*/
    {
    ...
    enum MultiRoiConfigurationInvalidReasonEnums    /*!< Displays the reason for invalid multiple ROI configuration.*/
    {
    ...
    enum ComponentDestinationEnums    /*!< Displays the destination of the selected component that is enabled (For example: stream 0/1/2 etc).*/
    {
    ...
    enum LensShadingCoefficientActiveSetEnums    /*!< Facilitates selection of on camera shading correction calibration files.*/
    {
    ...
    enum LensShadingCorrectionModeEnums    /*!< Activates Lens Shading Correction with the selected Lens Shading Coefficient Active Set.*/
    {
    ...
    enum SourceSelectorEnums    /*!< Control for selecting the source of the stream (i.e. Sensor 1 or Sensor 2). Component disparity uses the selected source as master and other source as slave for calcluating disparity.*/
    {
    ...
    enum StereoResolutionEnums    /*!< Selects the resolution output of the stereo engine. Stereo resolution can be viewed through Stereo Width and Stereo Height.*/
    {
    ...
    enum GevIEEE1588StatusLatchedEnums    /*!< IEEE 1588 Latched Status*/
    {
    ...
    enum GevPhysicalLinkConfigurationEnums    /*!< Indicates the principal physical link configuration currently enabled on this device.*/
    {
    ...
    enum UserSetDefaultEnums    /*!< Selects the feature User Set to load and make active by default when the device is reset.*/
    {
    ...
    enum Scan3dOutputModeEnums    /*!< Controls the Calibration and data organization of the device and  the coordinates transmitted.*/
    {
