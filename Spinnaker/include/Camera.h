...
namespace Spinnaker
{
    ...
    */
    ...
    public:
        ...
        /**
         * Description: If enabled, sensor is able to be triggered at sensor maximum frame rate. Device link throughtput will be ignored in calculating sensor maximum frame rate.
         * Visibility: 
         */
        ...
        /**
         * Description: Transfer frame rate in Hertz. If this does not equal the Acquisition Frame Rate it is because the Exposure Time is greater than the frame time.
         * Visibility: 
         */
        ...
        /**
         * Description: This feature is used only if the FrameBurstStart trigger is enabled and the FrameBurstEnd trigger is disabled. Note that the total number of frames captured is also conditioned by AcquisitionFrameCount if AcquisitionMode is MultiFrame and ignored if AcquisitionMode is Single.
         * Visibility: 
         */
        ...
        /**
         * Description: Enable the black level auto clamping feature which performs dark current compensation. This feature is not supported by rolling shutter sensors.
         * Visibility: 
         */
        GenApi::IBoolean &BlackLevelClampingEnable;

        /**
         * Description: White Balance compensates for color shifts caused by different lighting conditions. It can be automatically or manually controlled. For manual control, set to Off. For automatic control, set to Once or Continuous.
         * Visibility: 
         */
        GenApi::IEnumerationT<BalanceWhiteAutoEnums> &BalanceWhiteAuto;

        /**
         * Description: Controls the minimum intensity gradient change to invoke sharpening. When "Sharpening Auto" is enabled, this is determined automatically by the device. The threshold is specified as a fraction of the total intensity range, and ranges from 0 to 0.25. A threshold higher than 25% produces little to no difference than 25%. High thresholds sharpen only areas with significant intensity changes. Low thresholds sharpen more areas.
         * Visibility: 
         */
        GenApi::IFloat &SharpeningThreshold;

        /**
         * Description: Enables/disables the auto sharpening feature. When enabled, the camera automatically determines the sharpening threshold based on the noise level of the camera.
         * Visibility: 
         */
        GenApi::IBoolean &SharpeningAuto;

        /**
         * Description: Controls the amount to sharpen a signal. The sharpened amount is proportional to the difference between a pixel and its neighbors. A negative value smooths out the difference, while a positive value amplifies the difference. You can boost by a maximum of 8x, but smoothing is limited to 1x  (in float). Default value: 2.0
         * Visibility: 
         */
        ...
        /**
         * Description: Sets the automatic gain mode. Set to Off for manual control. Set to Once for a single automatic adjustment then return to Off. Set to Continuous for constant adjustment. In automatic modes, the camera adjusts the gain to maximize the dynamic range.
         * Visibility: 
         */
        GenApi::IEnumerationT<GainAutoEnums> &GainAuto;

        /**
         * Description: Selects which black level to control.  Only All can be set by the user. Analog and Digital are read-only.
         * Visibility: 
         */
        ...
        /**
         * Description: Controls the balance ratio of the selected color relative to green. Used for white balancing.
         * Visibility: 
         */
        GenApi::IFloat &BalanceRatio;

        /**
         * Description: Selects which gain to control. The All selection is a total amplification across all channels (or taps).
         * Visibility: 
         */
        ...
        /**
         * Description: Enables/disables the sharpening feature. Sharpening is disabled by default.
         * Visibility: 
         */
        ...
        /**
         * Description: Controls how quickly 'BalanceWhiteAuto' adjusts the values for Red and Blue BalanceRatio in response to changing conditions.  Higher damping means the changes are more gradual.
         * Visibility: 
         */
        ...
        /**
         * Description: This is the user-specified target grey level (image mean) to apply to the current image. Note that the target grey level is in the linear domain before gamma correction is applied.
         * Visibility: 
         */
        ...
        /**
         * Description: Selects a metering mode: average, spot, or partial metering. a. Average: Measures the light from the entire scene uniformly to determine the final exposure value. Every portion of the exposed area has the same contribution. b. Spot: Measures a small area (about 3%) in the center of the scene while the rest of the scene is ignored. This mode is used when the scene has a high contrast and the object of interest is relatively small. c. Partial: Measures the light from a larger area (about 11%) in the center of the scene. This mode is used when very dark or bright regions appear at the edge of the frame. Note: Metering mode is available only when Lighting Mode Selector is Normal.
         * Visibility: 
         */
        ...
        /**
         * Description: It controls how fast the exposure and gain get settled. If the value is too small, it may cause the system to be unstable. Range is from 0.0 to 1.0. Default = 0.2.
         * Visibility: 
         */
        GenApi::IFloat &AutoExposureControlLoopDamping;

        /**
         * Description: The EV compensation value used in the exposure compensation. This allows you to adjust the resultant image intensity with one control. A positive value makes the image brighter. A negative value makes the image darker. Range from -3 to 3 with a step of 1/3. Default = 0.
         * Visibility: 
         */
        ...
        /**
         * Description: This indicates whether the target image grey level is automatically set by the camera or manually set by the user. Note that the target grey level is in the linear domain before gamma correction is applied.
         * Visibility: 
         */
        ...
        /**
         * Description: Enables/disables the color transform selected with ColorTransformationSelector. For RGB to YUV this is read-only. Enabling/disabling RGB to YUV can only be done by changing pixel format.
         * Visibility: 
         */
        ...
        /**
         * Description: Used to select from a set of RGBtoRGB transform matricies calibrated for different light sources. Selecting a value also sets the white balance ratios (BalanceRatioRed and BalanceRatioBlue), but those can be overwritten through manual or auto white balance.
         * Visibility: 
         */
        ...
        /**
         * Description: Restores the Defective Pixel Table to its factory default state, which was calibrated during manufacturing. This permanently overwrites any changes made to the defect table.
         * Visibility: 
         */
        GenApi::ICommand &DefectTableFactoryRestore;

        /**
         * Description: Returns the Y coordinate of the defective pixel at DefectTableIndex within the defective pixel table. Changes made do not take effect in captured images until the command DefectTableApply is written.
         * Visibility: 
         */
        GenApi::IInteger &DefectTableCoordinateY;

        /**
         * Description: Saves the current defective pixel table non-volatile memory, so that it is preserved when the camera boots up. This overwrites the existing defective pixel table. The new table is loaded whenever the camera powers up.
         * Visibility: 
         */
        ...
        /**
         * Description: Returns the X coordinate of the defective pixel at DefectTableIndex within the defective pixel table. Changes made do not take effect in captured images until the command DefectTableApply is written.
         * Visibility: 
         */
        ...
        /**
         * Description: Each sensor has its own defect table in volatile memory. This selector controls which sensor's defect table is being accessed.
         * Visibility: 
         */
        ...
        /**
         * Description: Applies the current defect table, so that any changes made affect images captured by the camera. This writes the table to volatile memory, so changes to the table are lost if the camera loses power. To save the table to non-volatile memory, use DefectTableSave.
         * Visibility: 
         */
        ...
        /**
         * Description: Indicates the speed of transmission negotiated on the specified Link. (Bps)
         * Visibility: 
         */
        ...
        /**
         * Description: Limits the maximum bandwidth(in bps) of the data that will be streamed out by the device on the selected Link. If necessary, delays will be uniformly inserted between transport layer packets in order to control the peak bandwidth.
         * Visibility: 
         */
        ...
        /**
         * Description: Maximum bandwidth(in bps) of the data that can be streamed out of the device. This can be used to estimate if the physical connection(s) can sustain transfer of free-running images from the camera at its maximum speed.
         * Visibility: 
         */
        ...
        /**
         * Description: Selects the kind of generated output voltage: 3.3V, 5.0V, Adjustable (0-10V)
         * Visibility: 
         */
        GenApi::IEnumerationT<ExternalVoltageSelectorEnums> &ExternalVoltageSelector;

        /**
         * Description: Configures the adjustable voltage rail between 0.0 - 10.0V. Values are uniformly scaled from user input to maximum DAC values.
         * Visibility: 
         */
        ...
        /**
         * Description: Internally generated output voltage rail. Enable to supply external circuits with power. This is different than standard logic outputs in that it is comparatively slow to switch but can supply a more significant amount of power.
         * Visibility: 
         */
        ...
        /**
         * Description: The mode of the file when it is opened. The file can be opened for reading, writting or both. This must be set before opening the file.
         * Visibility: 
         */
        ...
        /**
         * Description: Selects which file is being operated on. This must be set before performing any file operations.
         * Visibility: 
         */
        ...
        /**
         * Description: Sets the auto BSI flat field correction mode.  Set to Off to manually set the correction gains.  Set to Continuous to automaticaly adjust the gains continually based on the current image content. Set to Once for a one-time admatic adjustment of the gains.
         * Visibility: 
         */
        GenApi::IEnumerationT<BsiFlatFieldCorrectionAutoEnums> &BsiFlatFieldCorrectionAuto;

        /**
         * Description: Controls how quickly BsiFlatFieldCorrectionAuto adjusts the values of BsiFlatFieldCorrectionGain. Higher damping means the gains are changed more gradually.
         * Visibility: 
         */
        GenApi::IFloat &BsiFlatFieldCorrectionAutoDamping;

        /**
         * Description: Selects flat field correction mode. Note that flat field correction parameters are accessible only in Calibration mode. When switching modes from Calibration to User or Factory, it is recommended to stop image streaming to give the camera enough time to load the corresponding table.
         * Visibility: 
         */
        ...
        /**
         * Description: Saves the current User flat field correction table into the camera, which means the table is still available after a power cycle. Note that this overwrites the existing saved User table.
         * Visibility: 
         */
        GenApi::ICommand &FfcUserTableSave;

        /**
         * Description: Resets the user flat field correction table to the last saved values loaded from the camera. If nothing has been previously saved, this resets to the default values which is the equivalent of disabling FFC.
         * Visibility: 
         */
        GenApi::ICommand &FfcUserTableReset;

        /**
         * Description: Controls the flat field correction gain of the pixel location specified by BsiFlatFieldCorrectionGainSelector. This is a linear multiplier applied to the pixel value.
         * Visibility: 
         */
        ...
        /**
         * Description: Minimum value that can be returned during the digitization process. This corresponds to the darkest value of the camera. For color cameras, this returns the smallest value that each color component can take.
         * Visibility: 
         */
        GenApi::IInteger &PixelDynamicRangeMin;

        /**
         * Description: Maximum desired datarate (B/s) for the compressed stream. If this is exceeded, then compression saturation priority type determines how the camera handles the payload.
         * Visibility: 
         */
        ...
        /**
         * Description: Maximum value that can be returned during the digitization process. This corresponds to the brightest value of the camera. For color cameras, this returns the biggest value that each color component can take.
         * Visibility: 
         */
        GenApi::IInteger &PixelDynamicRangeMax;

        /**
         * Description: Number of horizontal photo-sensitive cells to combine together. This reduces the horizontal resolution (width) of the image. A value of 1 indicates that no horizontal binning is performed by the camera. This value must be 1 for decimation to be active.
         * Visibility: 
         */
        ...
        /**
         * Description: Selects the Region of interest to control. The RegionSelector feature allows devices that are able to extract multiple regions out of an image.
         * Visibility: 
         */
        GenApi::IEnumerationT<MultiRoiSelectorEnums> &MultiRoiSelector;

        /**
         * Description: Horizontally flips the image sent by the device. The region of interest is applied after flipping. For color cameras the bayer pixel format is affected. For example, BayerRG16 changes to BayerGR16.
         * Visibility: 
         */
        GenApi::IBoolean &ReverseX;

        /**
         * Description: Vertically flips the image sent by the device. The region of interest is applied after flipping. For color cameras the bayer pixel format is affected. For example, BayerRG16 changes to BayerGB16.
         * Visibility: 
         */
        ...
        /**
         * Description: Type of color filter that is applied to the image. Only applies to Bayer pixel formats. All others have no color filter.
         * Visibility: 
         */
        GenApi::IEnumerationT<PixelColorFilterEnums> &PixelColorFilter;

        /**
         * Description: Maximum width of the image (in pixels). The dimension is calculated after horizontal binning. WidthMax does not take into account the current Region of interest (Width or OffsetX).
         * Visibility: 
         */
        ...
        /**
         * Description: Number of vertical photo-sensitive cells to combine together. This reduces the vertical resolution (height) of the image. A value of 1 indicates that no vertical binning is performed by the camera. This value must be 1 for decimation to be active.
         * Visibility: 
         */
        ...
        /**
         * Description: If selected, allows dynamic updates to the compression tables to achieve better compression ratio. If deselected, a fixed encoding table is used.
         * Visibility: 
         */
        GenApi::IBoolean &AdaptiveCompressionEnable;

        /**
         * Description: Selects which ADC bit depth to use. A higher ADC bit depth results in better image quality but slower maximum frame rate.
         * Visibility: 
         */
        ...
        /**
         * Description: Maximum height of the image (in pixels). This dimension is calculated after vertical binning. HeightMax does not take into account the current Region of interest (Height or OffsetY).
         * Visibility: 
         */
        GenApi::IInteger &HeightMax;

        /**
         * Description: Control for selecting the component of a source (i.e. Raw/Rectified/Disparity).
         * Visibility: 
         */
        GenApi::IEnumerationT<ComponentSelectorEnums> &ComponentSelector;

        /**
         * Description: Controls if the selected Region of interest is enabled. This can only be enabled if the Multiple ROI configuration is valid.
         * Visibility: 
         */
        GenApi::IBoolean &MultiRoiEnable;

        /**
         * Description: Horizontal decimation of the image.  This reduces the horizontal resolution (width) of the image by only retaining a single pixel within a window whose size is the decimation factor specified here. A value of 1 indicates that no horizontal decimation is performed by the camera. This value must be 1 for binning to be active.
         * Visibility: 
         */
        ...
        /**
         * Description: Controls whether the image processing core is used for optional pixel format mode (i.e. mono).
         * Visibility: 
         */
        GenApi::IBoolean &IspEnable;

        /**
         * Description: The mode used to reduce the horizontal resolution when DecimationHorizontal is used. The current implementation only supports a single decimation mode: Discard.  Average should be achieved via Binning.
         * Visibility: 
         */
        GenApi::IEnumerationT<DecimationHorizontalModeEnums> &DecimationHorizontalMode;

        /**
         * Description: Enabling lowers bandwidth usage or increases frame rate for typical scenes. For Lossless, ISP must be off and Pixel format must be Mono8 or BayerRG8.
         * Visibility: 
         */
        GenApi::IEnumerationT<ImageCompressionModeEnums> &ImageCompressionMode;

        /**
         * Description: Vertical decimation of the image.  This reduces the vertical resolution (height) of the image by only retaining a single pixel within a window whose size is the decimation factor specified here. A value of 1 indicates that no vertical decimation is performed by the camera. This value must be 1 for binning to be active.
         * Visibility: 
         */
        ...
        /**
         * Description: The mode used to reduce the vertical resolution when DecimationVertical is used. The current implementation only supports a single decimation mode: Discard.  Average should be achieved via Binning.
         * Visibility: 
         */
        ...
        /**
         * Description: Set up the camera parameters needed to be set for shading correction calibration. At least one image must be acquired after the setup for proper calibration.
         * Visibility: 
         */
        ...
        /**
         * Description: Displays the value of the horizontal position of the principal point, relative to the region origin, i.e. OffsetX .
         * Visibility: 
         */
        GenApi::IFloat &Scan3dPrincipalPointU;

        /**
         * Description: Displays the value of the vertical position of the principal point, relative to the region origin, i.e. OffsetY.
         * Visibility: 
         */
        ...
        /**
         * Description: Control for selecting the source of the stream (i.e. Sensor 1 or Sensor 2). Component disparity uses the selected source as master and other source as slave for calcluating disparity.
         * Visibility: 
         */
        ...
        /**
         * Description: Selects the resolution output of the stereo engine. Stereo resolution can be viewed through Stereo Width and Stereo Height.
         * Visibility: 
         */
        ...
        /**
         * Description: Port identity of the current best master. The clock ID is an Extended Unique Identifier (EUI)-64 64-bit ID.
         * Visibility: 
         */
        ...
        /**
         * Description: IEEE 1588 Latched Parent ID
         * Visibility: 
         */
        ...
        /**
         * Description: IEEE 1588 Latched Status
         * Visibility: 
         */
        ...
        /**
         * Description: Latches the current IEEE 1588 dataset
         * Visibility: 
         */
        GenApi::ICommand &GevIEEE1588DataSetLatch;

        /**
         * Description: Dynamically returns the 64-bit value of the PTP offset with the master, in nanoseconds. This value is the input for clock corrections for the slave device clock servo algorithms.
         * Visibility: 
         */
