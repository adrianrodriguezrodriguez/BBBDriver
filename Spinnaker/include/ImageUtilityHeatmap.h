...
namespace Spinnaker
{
    ...
    class SPINNAKER_API ImageUtilityHeatmap
    {
      public:
         ...
         *
         * @param srcImage The source image from which to create the heatmap
         * @param min The min image value to map to the heatmap low color
         * @param max The max image value to map to the heatmap high color
         * @param newLowColor New color at which to begin the gradient.
         * @param newHighColor New color at which to end the gradient.
         * @param doCheckInvalidVal Indication if to check for invalid values
         * @param invalidVal The invalid value. heatmap will be color coded with specific color to indicate invalid
         * pixels
         *
         * @see SetHeatmapRange()
         * @see SetHeatmapColorGradient()
