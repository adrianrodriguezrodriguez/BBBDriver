...
namespace Spinnaker
{
    ...
    class SPINNAKER_API CameraBase : public ICameraBase
    {
      public:
         ...
         * 
         * Note: This function should not be used together with GetNextImage. Results will be
         * undeterministic and could lead to missing or lost of images.
         *
         * @see Init()
         * @see BeginAcquisition()
         * @see EndAcquisition()
         ...
         * Returns the number of data streams that are currently active.
         *
         * @return The number of active data streams
         */
        unsigned int GetActiveNumDataStreams();

        /**
         * GetNumDataStreams
         * Returns the total number of streams that the device supports. For configurable multistream
         * cameras, use GetActiveNumDataStreams() to get the number of active streams.
         *
