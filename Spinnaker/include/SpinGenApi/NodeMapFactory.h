...
namespace Spinnaker
{
    namespace GenApi
    {
        ...
        // @brief The node map factory is used for creating node maps from camera description files. See the following for some examples.<br>
        ...
        You need to take care when camera description file data can be actually be freed, see method
        ...
        */
        ...
        class SPINNAKER_API CNodeMapFactory
        {
          public:
             ...
             * buffer to avoid that. gcstring cdfData;
             *                       //... fill cdfData ...
