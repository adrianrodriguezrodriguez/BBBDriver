...
namespace Spinnaker
{
    ...
    /**
     * @name Spinnaker Enum Definitions
     */
    ...
    enum Error
    {
        ...
        SPINNAKER_ERR_STEREO_INVALID_PIXEL_FORMAT = -3100,
        SPINNAKER_ERR_STEREO_RESOLUTION_MISMATCH = -3101,
        SPINNAKER_ERR_STEREO_INVALID_FILENAME = -3102,
        SPINNAKER_ERR_STEREO_INVALID_PLY_FILE = -3103,
        SPINNAKER_ERR_STEREO_MALLOC = -3104,
        SPINNAKER_ERR_STEREO_SPECKLE_FILTER = -3105,
     ...
     * image (image data) or the theoretical absolute max and min image data values for the image type (absolute
     * data). By default the absolute max and min values for an image are the max and min values allowable for the
    ...
    /**
     * @name Spinnaker Struct Definitions
     */
