...
namespace Spinnaker
{
    ...
    class SPINNAKER_API Image : public IImage
    {
      ...
      public:
         ...
         * on a per image basis.
         *
         * @return Transport Layer Device specific payload type.
         */
        size_t GetPayloadType() const;

        /**
         * Gets the GenTL specific payload type that was transmitted. This is a Transport
         * Layer specific value that identifies how the image was transmitted. This 
         * information is retrieved from the Transport Layer Image format headers. It is
         * retrieved on a per image basis.
         *
      ...
      protected:
        ...
        friend class ImageUtilityStereoImpl;
