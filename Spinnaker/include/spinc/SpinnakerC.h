...
extern "C"
{
    ...
    /**
     * Retrieves a image from a image list given its stream index. This
     * function will return a NULL spinImage pointer if no matching image
     * stream index is found.
     * @see spinError
     *
     * @param hImageList The image list of the image to retrieve
     * @param streamIndex The stream index of the image to retrieve
     * @param phImage The image handle pointer in which the image is returned
     *
     * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no error
     */
    SPINNAKERC_API spinImageListGetByStreamIndex(
        spinImageList hImageList, uint64_t streamIndex, spinImage* phImage);
     ...
     *
     * @param hImageList The image list of the image to remove
     * @param streamIndex The stream index of the image to remove
     *
     * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no error
     */
    ...
    */
    ...
    /*
     * Retrieves a pointer to memory of a piece of chunk data
     * @see spinError
     *
     * @param hImage The image of the chunk data to retrieve
     * @param pName The name of the piece of chunk data to retrieve
     * @param pData The uint8_t pointer in which the piece of chunk data is returned
     *
     * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no error
     */
    ...
    /*
     * Retrieves a boolean value of a piece of chunk data
     * @see spinError
     *
     * @param hImage The image of the chunk data to retrieve
     * @param pName The name of the piece of chunk data to retrieve
     * @param pValue The boolean pointer in which the piece of chunk data is returned
     *
     * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no error
     */
