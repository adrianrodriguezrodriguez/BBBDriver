...
namespace Spinnaker
{
    ...
    /**
     * @defgroup ImageList_h ImageList Class
     */
    ...
    class SPINNAKER_API ImageList : public IImageList
    {
      public:
         ...
         * This function will return a NULL ImagePtr if no image with matching pixel format
         * is found.
         *
        ...
        /**
         * Returns a pointer to an image object with the specified stream index. This 
         * function will return a NULL ImagePtr if no image with matching stream index is
         * found.
         *
         * @param streamIndex The stream index of the Image object to retrieve
         *
         * @return A pointer to a image object.
         */
         ...
         * This function will return a NULL ImagePtr if no image with matching image
         * payload type is found.
         *
         * @param payloadType The stream index of the Image object to retrieve
         *
         * @return A pointer to a image object.
         */
        ...
        /**
         * Removes an image object with the stream index from the list. This
         * function will throw a Spinnaker exception with SPINNAKER_ERR_INVALID_PARAMETER
         * error if the list does not have any image with the specified stream index.
         *
         * @param streamIndex The stream index of the Image object to retrieve
         */
        ...
        /**
         * Removes an image object with the specified payload type from the list. This
         * function will throw a Spinnaker exception with SPINNAKER_ERR_INVALID_PARAMETER
         * error if the list does not have any image with the specified payload type.
         *
         * @param payloadType The payload type of the Image object to retrieve
         */
