...
DECLARE_INTERFACE(ISpinDevice)
{
  public:
    ...
    /**
     * @name Spinnaker GenAPI Generic Functions
     *
    ...
    /**
     * @name Spinnaker GenAPI Integer Node Functions
     *
    ...
    /**
     * @name Spinnaker GenAPI Float Node Functions
     *
    ...
    /**
     * @name Spinnaker GenAPI Boolean Node Functions
     *
    ...
    /**
     * @name Spinnaker GenAPI String Node Functions
     *
    ...
    /**
     * @name Spinnaker GenAPI Enumeration Node Functions
     *
    ...
    /**
     * @name Spinnaker GenAPI Command Node Functions
     *
